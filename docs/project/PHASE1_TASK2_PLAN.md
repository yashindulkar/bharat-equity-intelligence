...
Success requires all requested gate tests, no network in tests, deterministic output, review records, clean checks, and a draft unmerged PR. Human/provider decisions remain visibly open. No score exists after a hard-gate failure.
