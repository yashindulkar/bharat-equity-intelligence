...
6. Exact Phase 1 universe, primary venue and reconciliation tolerance?
7. Authoritative `published_at` and `usable_from` rule; after-close cutoff and next-session execution semantics?
8. Which corporate actions enter Phase 1; how are rights, mergers, demergers, fractional entitlements and delistings represented?
9. Primary research horizon, benchmark total-return series, risk-free rate and dependence-aware uncertainty method?
10. How are corrections after a published research run shown: original-as-known, corrected, or both?

## Investor/security decisions (deferred to Phase 3+)
