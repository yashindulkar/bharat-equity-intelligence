...
REASON_CLASSIFICATION: dict[ReasonCode, ReasonSeverity] = {
    ...
    ReasonCode.TERMINATION_LIFECYCLE_MISSING: ReasonSeverity.HARD_BLOCK,
    ReasonCode.TERMINATION_LIFECYCLE_MISMATCH: ReasonSeverity.HARD_BLOCK,
    ReasonCode.TERMINATION_DELETION_EVIDENCE_MISSING: ReasonSeverity.HARD_BLOCK,
    ReasonCode.TERMINATION_DELETION_OVERDUE: ReasonSeverity.HARD_BLOCK,
    ReasonCode.ENVELOPE_MISMATCH: ReasonSeverity.HARD_BLOCK,
    ReasonCode.ENVELOPE_AGREEMENT_MISMATCH: ReasonSeverity.HARD_BLOCK,
    ReasonCode.ENVELOPE_POLICY_SNAPSHOT_MISMATCH: ReasonSeverity.HARD_BLOCK,
    ReasonCode.SCHEMA_NOT_ALLOWED: ReasonSeverity.HARD_BLOCK,
    ReasonCode.PROCESSING_GEOGRAPHY_UNKNOWN: ReasonSeverity.HARD_BLOCK,
    ReasonCode.SCORECARD_POLICY_MISMATCH: ReasonSeverity.HARD_BLOCK,
    ReasonCode.SCORECARD_FUTURE_ASSESSMENT: ReasonSeverity.HARD_BLOCK,
    ReasonCode.SCORECARD_FUTURE_EVIDENCE: ReasonSeverity.HARD_BLOCK,
    ReasonCode.RECONCILIATION_REMEDIATION_PENDING: ReasonSeverity.HARD_BLOCK,
    ReasonCode.RECONCILIATION_REMEDIATION_INVALID: ReasonSeverity.HARD_BLOCK,
    ReasonCode.EVALUATION_ARTIFACT_INVALID: ReasonSeverity.HARD_BLOCK,
}
